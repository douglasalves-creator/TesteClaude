...
const CAMPOS = [
  ...
  { cab: 'Material/Equipamento',  tipo: 'select', grupo: 'Identificação', lista: true, sol: true, opcoesDaValidacao: true, listaFechada: true , obrig: true, rotuloSol: 'Material/Equipamento Acionado', indice: true },
  { cab: 'Qtd',                   tipo: 'inteiro', grupo: 'Identificação', lista: true, sol: true, obrig: true, indice: true },
